...
#----Read the dataset------
getwd()
setwd("C:/AnalyticsEdge-R Programs")
Plan_Dataset <- read.csv("C:/AnalyticsEdge-R Programs/InsurancePlanSubscriptions-2017.csv")
View(Plan_Dataset)
df <- Plan_Dataset
View(df)
...
View(insurance_premium1)
#-------Regression Model--------------
reg_ins_formula <- lm(Annual_EE_Contri ~
                        #State1+
                        #Marital_status1 +# Division_1+
                        Age_Grp1+Age_Grp2#+Gender1 
                      +
                       # Annual_Salary_Bucket1+ 
                       # Annual_Salary_Bucket2+
...
setwd("C:/AnalyticsEdge-R Programs")
sm2 <- read.csv("C:/AnalyticsEdge-R Programs/InsurancePlanSubscriptions-2018.csv")
View(sm2)
